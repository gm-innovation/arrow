...
-- UNIQUE constraint já existe (quality_document_types_company_id_code_prefix_key)
...
BEGIN
  ...
  -- Caller precisa ser super_admin, director ou coordinator da empresa
  SELECT (
  ...
  -- Garante que o usuário pertence à empresa alvo
  IF NOT EXISTS (
...
GRANT EXECUTE ON FUNCTION public.quality_seed_safety_document_types(uuid) TO authenticated;